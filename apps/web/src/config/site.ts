...
export const site = {
  ...
  metadata: {
    ...
    description:
      "Seçil ve Uğur'un düğün daveti. 4 Ekim 2026 Pazar, saat 19.00, Aden Boğazköy Tesisleri, Arnavutköy, İstanbul. Katılım bildirimi için tıklayın.",
  ...
  share: {
    ...
    ogDescription: "4 Ekim 2026, Pazar · 19.00 · Aden Boğazköy Tesisleri, Arnavutköy",
